...
router.get('/qr/:sessionId', async (req, res) => {
    ...
    // Wait up to 12 seconds for QR code to be generated by Baileys
    let qr = getQR(sessionId);
    let attempts = 0;
    while (!qr && attempts < 24) {
    ...
    return res.status(404).send(`QR code is still initializing (Current Status: ${finalStatus || 'initializing'}). Please refresh this URL in 3 seconds.`);
});
